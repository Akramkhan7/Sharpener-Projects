        ...
        {items.map((item) => (
          ...
          >
            <div>
              ...
              <p className="text-xl text-gray-300 mt-2">x {item.quantity}</p>
            </div>
            ...
            <div className="text-right">
              ...
              <p className="text-gray-300 italic">(${item.price}/item)</p>

              <div className="flex gap-2 justify-end mt-4">
                <button
                  className="border border-white px-4 py-1 rounded text-white"
